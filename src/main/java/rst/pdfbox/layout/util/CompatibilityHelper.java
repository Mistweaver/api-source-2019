...
//import org.apache.pdfbox.pdmodel.graphics.PDPixelMap;
...
public class CompatibilityHelper {
	...
	// 2020-03-06 -- P.Spagnola
	// change bullet character code from 149 to 8226
	private final static String BULLET = Character.toString((char) 8226);
	...
	public static BufferedImage createImageFromPage(final PDDocument document,
		...
		// 2020-03-06 -- P. Spagnola
		// no longer necessary, PDFRenderer gets the page by page index
		//final PDPage page = (PDPage) document.getDocumentCatalog().getPages().get(pageIndex);

		PDFRenderer pdfRenderer = new PDFRenderer(document);
		BufferedImage bim = pdfRenderer.renderImageWithDPI(pageIndex, resolution, ImageType.RGB);
		return bim;
		// 2020-03-06 -- P. Spagnola
		// convertToImage doesn't work, use PDFRenderer instead
	...
	public static int getPageRotation(final PDPage page) {
		...
		// 2020-03-06 -- P. Spagnola
		// 'int' can never be null, have to catch NullPointerException instead
...
//	    pdxObjectImage = new PDImageXObject(document, image);
